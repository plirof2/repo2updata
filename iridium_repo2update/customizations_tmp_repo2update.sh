...
cat > ./$MYFILENAMEextracted/usr/share/applications/iridium-browser_changesdat.desktop << EOF2
[Desktop Entry]
Version=1.0
...
EOF31
chmod 755 ./$MYFILENAMEextracted/usr/bin/iridium-browser-puppy-sda1.sh

cat > ./$MYFILENAMEextracted/usr/share/applications/iridium-browser-puppy-sda1.desktop << EOF32
[Desktop Entry]
Version=1.0
...
if [ $SDB1SCRIPTS == true ]
then
cat > ./$MYFILENAMEextracted/usr/bin/iridium-browser-puppy-sdb1.sh << EOF41
#!/bin/sh
...
EOF41
chmod 755 ./$MYFILENAMEextracted/usr/bin/iridium-browser-puppy-sdb1.sh

cat > ./$MYFILENAMEextracted/usr/share/applications/iridium-browser-puppy-sdb1.desktop << EOF42
[Desktop Entry]
Version=1.0
...
echo "DONE with CUSTOMIZATION of /$MYFILENAMEextracted ........ "
#read -p "Done. Remember to create the puppy user. Press Enter: "